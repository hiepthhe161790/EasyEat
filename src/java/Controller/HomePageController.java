...
public class HomePageController extends HttpServlet {
    ...
    @Override
     protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Get latest menus
        List<WeeklyMenus> latestMenus = weeklyMenusDAO.getLatestMenus(3);
        request.setAttribute("latestMenus", latestMenus);

        // Get top selling menus
        List<WeeklyMenus> topSellingMenus = ordersDAO.getTopSellingMenus(3);
        request.setAttribute("topSellingMenus", topSellingMenus);
